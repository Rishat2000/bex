(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const firstSelect = document.querySelector(".select_first");
        const secondSelect = document.querySelector(".select_second");
        const switchButton = document.querySelector(".currency__switch");
        function swapBlocks() {
            const tempBlock = document.createElement("div");
            tempBlock.innerHTML = firstSelect.innerHTML;
        ...
        const marquee = document.querySelector(".standard__list");
        ...
        function animateMarquee() {
            ...
            function move() {
                pos -= animationSpeed;
                if (pos < -marqueeWidth) pos = containerWidth;
        ...
        swapButton.addEventListener("click", (() => {
            const temp = thirdSelect.innerHTML;
            thirdSelect.innerHTML = fourthSelect.innerHTML;
            fourthSelect.innerHTML = temp;
        }));
        const url = `https://rest.coinapi.io/v1`;
        async function getCurrencies(from, to) {
            try {
                await fetch(`${url}/exchangerate/${from}/${to}`, {
                    headers: {
                        "X-CoinAPI-Key": "EC413D49-3B51-48C3-AFBD-BE81F94C6CEE"
                    }
